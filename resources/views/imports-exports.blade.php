...
<div class="page-heading">
    ...
    <div class="d-flex flex-wrap gap-2">
        ...
        <a href="{{ asset('downloads/TUVAT CVS Inspection - Data Import Template.xlsx') }}" class="btn btn-info btn-sm">
            <i class="fa-solid fa-download me-1"></i> Blank Excel Template
        </a>
        <a href="{{ asset('downloads/TUVAT CVS Inspection - Sample Data File.xlsx') }}" class="btn btn-secondary btn-sm">
