                            ...
                            <div class="card-body">
                                ...
                                <form class="col s12" method="POST" action="{{ route('certificate.create') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="inspection_internal_notes" class="form-control" placeholder="Enter any inspection notes for internal use only." rows="4">{{ old('inspection_internal_notes') }}</textarea>
                                        <br>
