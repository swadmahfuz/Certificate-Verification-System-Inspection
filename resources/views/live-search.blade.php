                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            $.each(res.data.data, function(index, data) {
                                ...
                                _html += '<td>' + data.client_name + '</td>';
                                _html += '<td>' + data.inspection_type + '</td>';
                                _html += '<td>' + data.equipment_serial_chassis + '</td>';
                                _html += '<td>' + formatDate(data.inspection_date) + '</td>';
                                _html += '<td>' + formatDate(data.validity_date) + '</td>';
