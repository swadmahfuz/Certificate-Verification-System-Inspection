                            ...
                            <div class="card-body">
                                <table class="table table-striped" style="width:60%; margin-left:20%; margin-right:20%; border: 1px solid black;">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($certificate->inspection_location); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Equipment/Item</th>
                                        <td><?php echo e($certificate->equipment_name); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Manufacturer/Brand</th>
                                        <td><?php echo e($certificate->equipment_brand); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Serial/Chassis Number</th>
                                        <td><?php echo e($certificate->equipment_serial_chassis); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Rated Capacity</th>
                                        <td><?php echo e($certificate->equipment_rated_capacity); ?></td>
                                    </tr>
                                    <tr>
                                        <th>SWL</th>
                                        <td><?php echo e($certificate->equipment_swl); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($certificate->inspection_remarks); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Internal Notes</th>
                                        <td><?php echo e($certificate->inspection_internal_notes); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Created by</th>
...
<?php /**PATH D:\xampp\htdocs\verify-cert-inspection\resources\views/view-certificate.blade.php ENDPATH**/ ?>